<template>
    <div class="content four-block-box">
        ...
        <oblique-angle-rect class="font-size-base" :rectHeight="rectHeight"
            ...
            <div class="hBox vh_content_center table-box emphasis-attention-company-coal">
                <el-table
                        :data="tableData"
...
export default {
    ...
    methods: {
        ...
        readyRoll () {
            this._trHeight = document.querySelector('div.emphasis-attention-company-coal table  thead  tr').offsetHeight;
