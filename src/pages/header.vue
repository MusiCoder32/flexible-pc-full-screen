  ...
  <div class="vBox vh_content_start">
    <div class="header font-size-medium">
      ...
      <div @click="goto('coal')" class="menu hBox vh_items_center header-not-coal-icon">
        <img class="mr8" src="../assets/img/web1x_非煤logo_img.png" /> 金属非金属矿山安全生产风险智能监测系统
      </div>
      <div @click="goto('chemical')" class="menu hBox vh_items_center header-chemical-icon">
        <img class="mr8" src="../assets/img/web1x_化工logo_img.png" /> 化工园区危险化学品应急监控及事故预警系统
      </div>
      <div class=" hBox vh_content_between vh_items_center header-left">
        <div class="hBox vh_items_center header-left-date">
          <img class="mr8" src="../assets/img/web1x_日期icon_img.png" /> {{date}}
        </div>
        <div class=" hBox vh_items_center header-left-time">
          <img class="mr8" src="../assets/img/web1x_时间icon_img.png" height="20" width="20" /> {{time}}
        </div>
        <!-- 全屏显示 -->
        <div class="header-left-full-screen hBox vh_items_center" @click="handleFullScreen">
          <el-tooltip effect="dark" :content="fullscreen?`取消全屏`:`全屏`" placement="bottom">
            <img class="mr8" v-if="fullscreen" src="../assets/img/web1x_退出全屏icon_img.png" /> <img class="mr8" v-if="!fullscreen" src="../assets/img/web1x_全屏展示icon_img.png" />
          </el-tooltip>
          {{!fullscreen? '全屏展示':'取消全屏'}}
        </div>
        <div class="hBox vh_items_center"  @click="logout">
          <el-tooltip effect="dark" content="退出" placement="bottom">
            <img src="../assets/img/logout.png" height="18" width="18" />
          </el-tooltip>
